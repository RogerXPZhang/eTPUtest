...
void HWInitPowerOn(void)
{
	...
	//initADC0();
	//initGPIO();
	SIU.PCR[122].R = 0x0600;          /* Configure pad for signal ETPU_A[8] output*/
	SIU.PCR[123].R = 0x0600;          /* Configure pad for signal ETPU_A[9] output*/
	SIU.PCR[124].R = 0x0600;          /* Configure pad for signal ETPU_A[10] output*/
	SIU.PCR[125].R = 0x0600;          /* Configure pad for signal ETPU_A[11] output*/
	SIU.PCR[126].R = 0x0600;          /* Configure pad for signal ETPU_A[12] output*/
	SIU.PCR[127].R = 0x0600;          /* Configure pad for signal ETPU_A[13] output*/
	SIU.PCR[128].R = 0x0600;          /* Configure pad for signal ETPU_A[14] output*/
...
void main (void) 
{
	...
	fs_etpu_pwmmac_enable_3ph(PWMMAC0_MASTER,FS_ETPU_PWMMAC_PIN_LOW,FS_ETPU_PWMMAC_PIN_HIGH);
